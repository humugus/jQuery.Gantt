        ...
        var core = {
            ...
            */
                ...
                $.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage && i < (element.pageNum * settings.itemsPerPage + settings.itemsPerPage)) {
                        ganttLeftPanel
							...
							.append($('<div class="row desc row' + i + ' "/>').append($('<span title="' + entry.desc + '"class="fn-label"/>').html(entry.desc)));
                    }
                });
            ...
            createProgressBar: function (days, cls, desc, label, dataObj) {
                ...
                var bar = $('<div title="' + label + '" class="bar"><div class="fn-label">' + label + '</div></div>')
						.addClass(cls)
						.css({
